...
$script_dir/2-setup-bioinformatics-virtualenv.sh $1
...
echo -e "After you have done that, navigate back to the research-master directory and type: workon bioinformatics
